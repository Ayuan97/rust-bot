...
function DeviceControl({ serverId, isReadOnly = false }) {
  ...
  // 虚拟演示设备：当真实列表为空时显示
  const demoDevices = [
    { id: 'demo1', entityId: 12345, name: '示例_核心房大门', type: 'Door', currentValue: false, autoMode: 0 },
    { id: 'demo2', entityId: 67890, name: '示例_基地外围炮塔', type: 'Turret', currentValue: true, autoMode: 7 },
    { id: 'demo3', entityId: 11223, name: '示例_自动感应灯', type: 'Light', currentValue: false, autoMode: 2 },
  ];
          ...
          {filteredDevices.map((device) => (
            ...
            >
              <div className="bg-black/40 p-5 h-full flex flex-col relative overflow-hidden">
                <button
                  onClick={() => !isDemo && togglePin(device.entityId)}
                ...
                <div className="flex-1 flex flex-col justify-end space-y-4 relative z-10">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-white/5">
                    ...
                    <div className="flex gap-2">
                      ...
                      <ActionBtn onClick={() => handleDeleteDevice(device.entityId)} icon={<FaTrash />} title="注销" variant="danger" disabled={isReadOnly || isDemo} />
                    </div>
                  </div>
                </div>
              </div>
